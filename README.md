...
In the past decade, we have entered what is known as the "Mobile first paradigm" of styling. Web developers now have to create something that will look good on many different sized devices, with our smaller Mobile screens taking up a massive share of our screen time. would look wildly different on an . Having a font size of 36px and a margin of 50px might look great on your Macbook screen in development, but how is it going to look on your Apple Watch when the page is deployed?
